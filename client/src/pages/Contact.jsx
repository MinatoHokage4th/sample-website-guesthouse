    ...
    <div className="contact-page">
      ...
      <div className="contact-wrapper">
        <div className="about-section" data-aos="fade-right">
          ...
          <p>
            ExclusiveKost Surabaya adalah pengelola kost premium dengan 2 gedung
            di lokasi strategis dekat kampus ITS dan UBAYA. Kami mengutamakan
            kenyamanan, keamanan, dan fasilitas modern untuk mendukung gaya
            hidup urban Anda.
          </p>
          <div className="contact-info">
            <h4>Alamat:</h4>
            <p>
              <strong>Gedung 1:</strong> Jl. Teknik Kimia No.10, Sukolilo (Dekat
              ITS)
            </p>
            <p>
              <strong>Gedung 2:</strong> Jl. Raya Ngagel No.25, Wonokromo (Dekat
              UBAYA)
            </p>
